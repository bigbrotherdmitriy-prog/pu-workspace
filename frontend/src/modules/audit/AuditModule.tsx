...
type Props = { collapsed: boolean; projectId: number | null; logs: AuditRow[]; query: string; onReload: () => void };

export function AuditModule({ collapsed, projectId, logs, query, onReload }: Props) {
  ...
  return <section className={`module-overlay ${collapsed ? "collapsed" : ""}`}><div className="module-page">
    <EvidenceTrailPanel projectId={projectId} />
