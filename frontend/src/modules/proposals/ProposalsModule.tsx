...
export function ProposalsModule(props: Props) {
  return <section className={`module-overlay ${props.collapsed ? "collapsed" : ""}`}><div className="module-page">
    ...
    <section className="card proposal-intro"><div><h2>Предлагаемые изменения</h2><p>Пакеты «Безопасная копия» не затрагивают оригиналы. В пакетах «Оригинал» можно применить только одно явно выбранное изменение.</p></div><span>{props.proposals.length} пакетов</span></section>
