...
import { parseProjectOrganization, parseSupplyList } from "./supplyReadModel";
...
describe("SupplyCenter", () => {
  ...
  it("fails closed when an action needs a new evidence pin", async () => {
    ...
    expect(screen.getByRole("alert")).toHaveTextContent("новое точное доказательство");
