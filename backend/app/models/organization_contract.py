...
class ContractVersion(Base):
    ...
    Schema-only for now: no caller writes to this table yet. Recording
    versions on contract create/update/apply is a future MVP-3 feature,
    out of scope for this port (see docs/audits/
    mvp1-main-integration-alembic-preflight.md section 6, decision 3).
    """
